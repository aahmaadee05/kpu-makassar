...
class Tb_kecamatan_model extends CI_Model
{

    public $table = 'tb_kecamatan';
    public $id = 'id';
    public $order = 'DESC';
...
/* End of file Tb_kecamatan_model.php */
/* Location: ./application/models/Tb_kecamatan_model.php */
