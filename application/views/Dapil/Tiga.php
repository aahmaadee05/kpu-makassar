            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                      <form action="cetak_tiga" method="post">
                        <?php
                        ...
                        <table class="table table-bordered" style="margin-bottom: 10px">
                          ...
                          <?php 
                              $caleg_data = $this->Dapil_model->get_caleg3($partaii->id);
                          ...
                          <tr>
                            ...
                            ?>
                          <?php 
                              $suara_partai = $this->Dapil_model->get_supar3($partaii->id);
